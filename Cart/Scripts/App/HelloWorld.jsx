const DynamicForm = () => {
    ...
    React.useEffect(() => {
        ...
        fetchItems();
    }, [currentPage, items]); // Empty dependency array ensures this runs only once when the component mounts


    const inputRef = React.useRef(null);

    React.useEffect(() => {
        // Manipulate the DOM directly by focusing the input
        inputRef.current.focus();
    }, [currentPage, items]); // Empty dependency array to run this only once after mount
